...
class Hand:
    def __init__(self):
        self.orig_image = image.load("Assets/bucket.jpg", size=(HAND_SIZE, HAND_SIZE))
        self.image = self.orig_image.copy()
        self.image_smaller = image.load("Assets/bucket.jpg", size=(HAND_SIZE - 50, HAND_SIZE - 50))
    ...
    def draw_hitbox(self, surface):
        pygame.draw.rect(surface, (200, 60, 120), (self.rect[0], 700))


    def draw(self, surface):
        image.draw(surface, self.image, (self.rect.center[0],500), pos_mode="center")
